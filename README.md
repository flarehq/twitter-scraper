...
[![Go Reference](https://pkg.go.dev/badge/github.com/flarehq/twitter-scraper.svg)](https://pkg.go.dev/github.com/flarehq/twitter-scraper)
...
```shell
go get -u github.com/flarehq/twitter-scraper
```
...
import (
    "context"
    "fmt"
    twitterscraper "github.com/flarehq/twitter-scraper"
)
